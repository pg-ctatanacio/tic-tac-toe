...
const Extreme = () => {
    ...
    return (
        <div className="extreme-board">
            ...
            <div className="extreme-board__status">
                {renderMoveLabel()}
            </div>
            <div className="extreme-board-col">
                <Board isFocused={0 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[0]} boardNo={0} squares={squares[0]} onHandleExtremePlay={handlePlay2} isExtreme />
                <Board isFocused={1 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[1]} boardNo={1} squares={squares[1]} onHandleExtremePlay={handlePlay2} isExtreme />
                <Board isFocused={2 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[2]} boardNo={2} squares={squares[2]} onHandleExtremePlay={handlePlay2} isExtreme />
            </div>
            <div className="extreme-board-col">
                <Board isFocused={3 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[3]} boardNo={3} squares={squares[3]} onHandleExtremePlay={handlePlay2} isExtreme />
                <Board isFocused={4 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[4]} boardNo={4} squares={squares[4]} onHandleExtremePlay={handlePlay2} isExtreme />
                <Board isFocused={5 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[5]} boardNo={5} squares={squares[5]} onHandleExtremePlay={handlePlay2} isExtreme />
            </div>
            <div className="extreme-board-col">
                <Board isFocused={6 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[6]} boardNo={6} squares={squares[6]} onHandleExtremePlay={handlePlay2} isExtreme />
                <Board isFocused={7 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[7]} boardNo={7} squares={squares[7]} onHandleExtremePlay={handlePlay2} isExtreme />
                <Board isFocused={8 === lastMoveIndex && !isFirstMove} boardWinner={boardWinner[8]} boardNo={8} squares={squares[8]} onHandleExtremePlay={handlePlay2} isExtreme />
            </div>
            <div>
                <Button text='Undo' />
                <Button text='Redo' />
